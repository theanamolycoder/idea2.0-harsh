...
from app.api.monte_carlo.scenario_generator import (
    generateScenario,
...
from app.api.graph.graph_queries import (
    queryAllVendors,
...
async def getAllVendors() -> Dict:
    try:
        ...
        graph = app.state.graph
        from app.api.propagation.dependency_mapper import getAllNodes
